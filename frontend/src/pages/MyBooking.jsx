...
const MyBooking = () => {s
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-start gap-[50px] relative flex-col">
          ...
          <div className=" w-[50%] h-[10%] border-[2px] border-[#FF385C] p-[15px] flex items-center justify-center text-[30px] rounded-md text-[#4a3434] font-semibold mt-[20px] md:w-[600px] ">MY BOOKING</div>
          
    
    
          <div className=" w-[100%] h-[90%] flex items-center justify-center gap-[25px] flex-wrap mt-[30px]">
    
          {userData.booking?.map((list, i) => (
          <Card
            title={list.title}
